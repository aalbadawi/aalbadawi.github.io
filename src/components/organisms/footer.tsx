...
export default function Footer() {
  ...
  const typewriterStrings = useMemo(
    () => [...typeWriteList].sort(() => 0.5 - Math.random()),
    [],
  )
  ...
  return (
    <div className="custom-scrollbar flex min-h-screen w-full flex-col justify-between items-center overflow-y-auto lg:overflow-y-hidden px-4 pt-20 pb-2 sm:px-6 md:pt-24 lg:px-8">
          ...
          >
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
              <div>
                ...
                <input
                  ...
                  placeholder={
                    t('page.contact.email-placeholder') || 'name@example.com'
                  }
                  required
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="block w-full rounded-xl border border-slate-200 bg-white/90 px-3.5 py-2 text-xs text-slate-900 shadow-sm transition-all placeholder:text-slate-400 focus:border-orange-500 focus:outline-none focus:ring-2 focus:ring-orange-500/20 dark:border-slate-700/80 dark:bg-slate-900/90 dark:text-white dark:placeholder-slate-500 sm:text-sm"
                  placeholder={
                    t('page.contact.subject-placeholder') || 'Project Inquiry'
                  }
                  required
                />
              </div>
            ...
            <div>
              ...
              <textarea
                ...
                className="block w-full rounded-xl border border-slate-200 bg-white/90 px-3.5 py-2 text-xs text-slate-900 shadow-sm transition-all placeholder:text-slate-400 focus:border-orange-500 focus:outline-none focus:ring-2 focus:ring-orange-500/20 dark:border-slate-700/80 dark:bg-slate-900/90 dark:text-white dark:placeholder-slate-500 sm:text-sm"
                placeholder={
                  t('page.contact.your-message-placeholder') ||
